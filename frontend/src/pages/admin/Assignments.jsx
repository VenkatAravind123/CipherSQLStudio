...
export default function Assignments() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await fetch(`${API}/api/admin/getallassignments`, {
          credentials: "include",
        });
  ...
  return (
    <section className="page1 admin-assignments">
      <div className="admin-assignments__header">
        <div>
          <h1>Assignments</h1>
          <p>Manage all SQL assignments.</p>
        </div>
        <button
          className="admin-assignments__create-btn"
      ...
      {loading ? (
        ...
        <div className="admin-assignments__empty">
          ...
          <p>Create your first SQL assignment to get started.</p>
          <button
            className="admin-assignments__create-btn"
            onClick={() => navigate("/admin/assignments/create")}
          >
            ...
            <div key={a._id} className="admin-assignments__card">
              ...
              <div className="admin-assignments__card-actions">
                <button
                  ...
                  onClick={() => navigate(`/admin/assignments/edit/${a._id}`)}
                >
                  Edit
                </button>
                <button
                  className="admin-assignments__action-btn admin-assignments__action-btn--delete"
